...
<body class="bg-gray-50 text-gray-900">
    ...
    <header class="bg-white shadow p-4 sticky top-0 z-20">
                ...
                <ul class="flex flex-col md:flex-row md:space-x-6 text-base font-medium">
                    ...
                    <li>
                        ...
                        <div class="hidden md:flex items-center gap-2 cursor-pointer" title="Usuario">
                            <a href="profile.php" class="flex items-center gap-2" title="Usuario"> <img
                                    src="https://i.pravatar.cc/150?u=fake@pravatar.com" alt="Avatar usuario"
        ...
        <div id="mobile-menu"
            ...
            <div class="border-t mt-4 pt-4 px-4 flex items-center gap-3 cursor-pointer">
                <a href="profile.php" class="flex items-center gap-2" title="Usuario">
    ...
    <script>
        ...
        document.querySelectorAll('#nav-menu a[href^="#"], #mobile-menu a[href^="#"]').forEach(anchor => {
